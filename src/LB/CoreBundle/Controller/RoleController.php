...
namespace LB\CoreBundle\Controller;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;

use LB\CoreBundle\Entity\Role;
use LB\CoreBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LBCoreBundle:Role')->findAll();

        return $this->render('LBCoreBundle:Role:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('LBCoreBundle:Role:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LBCoreBundle:Role')->find($id);
        ...
        return $this->render('LBCoreBundle:Role:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('LBCoreBundle:Role:edit.html.twig', array(
            'entity'      => $entity,
